...
export const localities: Locality[] = [
  {
    ...
    description:
      'Gated plots on the Jewar growth corridor - Yamuna Expressway access, Noida International Airport, and Film City-led infrastructure. Hari Shyam Township and Rama Enclave.',
    propertyCount: 2,
...
export const heroPlotImages = [
  ...
  { src: '/images/plots/ram-enclave/gate-cover.png', title: 'Rama Enclave', locality: 'Jewar / Yamuna Expressway' },
