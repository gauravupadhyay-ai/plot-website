...
interface PageHeroProps {
   ...
   * Default biases toward the lower portion so faces/subjects stay in frame.
   */
...
/**
 * Page hero with LCP-safe image (paints first) and scroll parallax after hydration.
 */
  ...
  return (
    <section className="bg-brand-light px-3 pb-5 pt-20 sm:px-5 sm:pb-8 sm:pt-24 lg:px-6 lg:pt-28">
      ...
      <div className="relative mx-auto max-w-[90rem] overflow-hidden rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem]">
        <div className="relative flex min-h-[48vh] items-start justify-start sm:min-h-[52vh] md:min-h-[56vh] lg:min-h-[60vh]">
          <ParallaxImage
            src={image}
            alt={title}
            priority
          ...
          <div className="relative z-10 w-full px-4 pb-16 pt-6 text-left sm:px-8 sm:pb-20 sm:pt-8 md:px-12 md:pt-10 md:pb-20 lg:px-14 lg:pt-12">
